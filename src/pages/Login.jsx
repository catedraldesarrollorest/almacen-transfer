    ...
    <div className="min-h-screen bg-primary flex items-center justify-center p-4">
      <div className="w-full max-w-xs">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Transferencias Catedral</h1>
          <p className="text-red-200 text-sm mt-1">Ingresa tu PIN para acceder</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-white/10 rounded-2xl p-4 mb-4 text-center">
            <div className="flex justify-center items-center gap-3 h-10">
              {pin.length === 0 ? (
                <span className="text-red-200 text-sm">Ingresa tu PIN</span>
              ) : (
